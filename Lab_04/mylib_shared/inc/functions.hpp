...
class __declspec(dllexport) Logger {
    ...
    public:
        ...
        static __declspec(dllexport) void INFO(int loglevel, const std::string text,const std::string object_name, const std::string message, const int count);
